...
//     if ((unsigned char *)inner + inner_ip->ihl * 4 + sizeof(struct udphdr) > buf + len)
//         return (0);
...
//     return (inner_udp->dest == htons(expected_port));
// }
...
//             dest_port = htons(port + ttl + probe);
...
//                     printf("%s (%d.%d.%d.%d) ", host, ip_bytes[0], ip_bytes[1], ip_bytes[2], ip_bytes[3]);
//                 else
//                     printf("%d.%d.%d.%d (%d.%d.%d.%d) ", ip_bytes[0], ip_bytes[1], ip_bytes[2], ip_bytes[3], ip_bytes[0], ip_bytes[1], ip_bytes[2], ip_bytes[3]);
//                 shown_host = 1;
//             }
//             printf("%.3f ms  ", rtt);
